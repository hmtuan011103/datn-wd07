                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">Cập nhật Xe</h4>
                            </div><!-- end card header -->

                            <div class="card-body">
                                <form class="tablelist-form" autocomplete="off" action="{{ route('update_car', $model) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 pt-3 pb-3">
                                                ...
                                                <input type="file" value="{{$model->image}}" name="image" id="image" class="form-control" placeholder="Nhập Tên Chuyến Xe"  />
                                            </div>
                                            <div class="col-md-6 pt-3 pb-3">
                                            ...
                                            <div class="col-md-6 pt-3 pb-3">
                                                ...
                                                <select class="form-control" aria-label="Default select example" name="status">
                                                    <option value="0" @if ($model->status == 0) selected @endif>Xe Đang Hoạt Động</option>
                                                    <option value="1" @if ($model->status == 1) selected @endif>Xe Đã Ngừng Hoạt Động</option>
                                                </select>
                                            </div>
                                            <div class="md-3">
...
@endsection
@section('script')
    @include('admin.pages.car.script')
@endsection
