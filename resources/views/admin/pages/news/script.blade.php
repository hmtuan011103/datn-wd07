...
{!! JsValidator::formRequest('App\Http\Requests\NewPost\StoreNewRequest') !!}
{!! JsValidator::formRequest('App\Http\Requests\NewPost\UpdateNewRequest') !!}
...
var options = {
     valueNames: ["id", "tieu_de", "hinh_anh", "nguoi_tao", "action"],
     page: perPage,
     pagination: !0,
...
function deleteMultiple() {
     ...
     if (
          ...
          var urlAjaxRequest = "/api/news/destroy-multiple";
