            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('save_edit_trip',['id' => $trip->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
									<div class="col-md-6">
									  ...
									  <div class="col-md-6">
										<div class="form-group has-feedback">
										  ...
										  <select class="form-control" name="user_id">
                                              ...
                                              {{-- <option value="{{$user->id}}" {{$user->id}} == {{$trip->user_id}} ? "selected" : "">{{$user->name}}</option> --}}
                                              <?php $selected = $user->id == $trip->user_id ? 'selected' : ''; ?>
									...
									<div class="col-md-6">
									  <div class="form-group has-feedback">
										...
										<input class="form-control" name="start_date" value="{{$trip->start_date}}" placeholder="Mô tả" type="date">
										<span  aria-hidden="true"></span> </div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group has-feedback">
										  ...
										  <input class="form-control" name="start_time" value="{{$trip->start_time}}"  placeholder="Mô tả" type="time">
										  <span  aria-hidden="true"></span> </div>
									  </div>
									  ...
									  <div class="col-md-6">
										<div class="form-group has-feedback">
										  ...
										  <input class="form-control" value="{{$trip->trip_price}}.000"  onChange="format_curency(this);"  name="trip_price" placeholder="VND" type="number">
										  <span  aria-hidden="true"></span> </div>
									  </div>
									  <div class="col-md-6">
										<div class="form-group has-feedback">
									  ...
									  <div class="col-md-6">
										<div class="form-group has-feedback">
										  ...
										  <input class="form-control" name="end_location" value="{{$trip->end_location}}" placeholder="Điểm kết thúc" type="text">
										  <span  aria-hidden="true"></span> </div>
									  </div>
									  ...
									  {{-- <div class="col-md-6">
										<div class="form-group has-feedback">
										  ...
										  <input class="form-control" name="status" placeholder="Mô tả" value="{{$trip->status}}" type="hidden">
										  {{-- <span  aria-hidden="true"></span> </div>
									  </div> --}}
