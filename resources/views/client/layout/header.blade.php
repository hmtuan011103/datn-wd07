...
<body>
    <header class="w-full-container header-page-image header">
        <div class="header-desktop container">
                <div class="pt-3 d-flex justify-content-between">
                    ...
                    <div id="button_login" class=" btn rounded-pill bg-white w-btn-lg-rg align justify-content-evenly">
                        <div class="d-flex ">
                            ...
                            <div class="fs-14">
                                <a href="{{ route('auth') }}" class="text-decoration-none cl-black fw-normal">Đăng
                                    nhập/</a>
                            </div>
                            <div class="fs-14">
                                <a href="{{ route('auth') }}" class="text-decoration-none cl-black fw-normal">Đăng
                    ...
                    <div id="button_logout" class="rounded-pill bg-white align justify-content-evenly"
                        style="display: none">
                                    ...
                                    <ul class="list-group mb-0">
                                        <li class="list-group-item py-3">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('client/assets/images/Profile.svg') }}"
                                                    alt="" class="mr-2">
                                                <a class="dropdown-item" id="profile" href="#">Thông tin tài
                                                    khoản</a>
                                            </div>
                                        </li>
                                        <li class="list-group-item py-3">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('client/assets/images/History.svg') }}"
                                                    alt="" class="mr-2">
                                        ...
                                        <li class="list-group-item py-3">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('client/assets/images/Password.svg') }}"
                                                    alt="" class="mr-2">
                                        ...
                                        <li class="list-group-item py-3">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('client/assets/images/Logout.svg') }}" alt=""
                                                    class="mr-2">
                ...
                <nav class="pt-3 pb-4">
                    <ul class="nav nav-underline justify-content-center gap-4">
                        <li class="nav-item">
                            <a class="nav-link hover-item-menu text-uppercase fs-14 cl-white fw-medium w-100 d-block "
                                aria-current="page" href="{{ url('/') }}">Trang chủ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link hover-item-menu text-uppercase fs-14 cl-white fw-medium w-100 d-block "
                        ...
                        <li class="nav-item">
                            <a class="nav-link hover-item-menu text-uppercase fs-14 cl-white fw-medium w-100 d-block "
                                href="{{ url('/ve-chung-toi') }}">Về chúng tôi</a>
                        </li>
                    </ul>
                </nav>
        </div>
        <div class="header_mobile">
            <div class="menu_set">
                <div class="container">
                    <div class="btn_menu_mobile col-3">
                    ...
                    <div class="logo col-6">
                        <div class="img_logo">
                            <img src="{{ asset('client/assets/images/logo_web.png') }}" alt="" width="100%">
                        </div>
                    </div>
                    <div class="login col-3">
                        <a href="{{ route('auth') }}">
                              <i class="fa-solid fa-circle-user icon-user-bg fa-xl" style="padding-left:35px;"></i>
                        </a>
            ...
            <div class="menu_move">
                <ul>
                    ...
                    <div class="lines"></div>
                    <li>
                        <a href="{{ url('/lich-trinh') }}">Lịch trình</a>
                    </li>
                    <div class="lines"></div>
                    <li>
                        <a href="{{ url('/tra-cuu') }}">Tra cứu vé</a>
                    </li>
                    <div class="lines"></div>
                    <li>
