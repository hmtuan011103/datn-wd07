@include('client.pages.review.style')
<div class="contact container mt-3 mb-5">
    <div class="contact-left col-md-4 col-10">
        {{-- <h4>LIÊN HỆ VỚI CHÚNG TÔI</h4> --}}
        <img src="{{ asset('client/assets/images/review.svg') }}" width="100%" alt="">
    </div>
    <div class="contact-right col-md-6 col-10">
        <div class="title">
            <img src="https://futabus.vn/images/icons/mail_send.svg" alt="">
            <span> Đánh giá sau khi trải nghiệm dịch vụ của chúng tôi</span>
        </div>
        <form action="{{ route('create_review') }}" method="POST">
            @csrf
            <div class="row">
                <div class="feedback">
                    <div class="rating">
                        ...
                        {{-- <input type="radio" name="stars" value="" checked> --}}
            ...
            <div class="row mb-3">
                <div class="form-group col-md-12">
                    <textarea class="form-control" name="content_evaluate" rows="3" placeholder="Nhập ghi chú">{{isset($data['content']) ? $data['content'] : ''}}</textarea>
                </div>
            </div>
