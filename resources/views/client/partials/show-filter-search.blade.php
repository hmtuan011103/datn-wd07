    <form class="content-container-right ps-4 w-70">
    <p class="title-trip-found fs-20 fw-medium">Hà Nội - Nam Định <span>(15)</span></p>
    <div class="d-flex">
    ...
    <div class="p-4 border border-1 rounded-3 mt-3 w-100">
        ...
        <div class="d-flex pt-4 justify-content-between align-items-center">
            ...
            <div>
                <button class="btn btn-primary fs-14 fw-medium cl-orange rounded-pill bg-button-choose-trip px-4">Chọn chuyến</button>
            </div>
        </div>
    </div>
</form>
