        ...
        <div class="row pt-2 flex-wrap mx-auto recent-news-slide" id="recent-news-container">
            {{-- <div class="col-4">
                <a href="" class="d-block border border-1 rounded-3">
                    <img src="{{ asset('client/assets/images/image-sale.png') }}" alt=""
                        class="w-100 d-block border border-1 rounded-3">
                </a>
                <a class="text-uppercase fw-bold pt-2 pb-3 d-block text-decoration-none cl-black show-three-dot-text">
                    CHIẾN THẮNG ĐỒNG HÀNH CÙNG SHB - X3 QUÀ TẶNG
                </a>
