        ...
        y = (function (t) {
            function e(e) {
                ...
                return (
                    ...
                    (i._rootElement = new f("g", { id: "jvm-regions-group" })),
        ...
        M = (function (t) {
            function e(e) {
                ...
                ((i = t.call(this) || this).config = arguments[0]),
                    (i.canvas = s.canvas),
                    (i.map = s),
                    (i.shape = i.canvas.createPath({ d: n, dataCode: a }, r)),
    ...
    var C = (function (t) {
        function e(e) {
            ...
            return (
                ...
                ]({ dataIndex: s, cx: r, cy: o }, i._getStyle(), l)),
    ...
    var A = {
            handleContainerEvents: function () {
                ...
                this.params.draggable &&
                    (w.on(this.container, "mousemove", function (n) {
                        if (!s) return !1;
                    ...
                    this.params.zoomOnScroll &&
                        w.on(this.container, "wheel", function (t) {
                            var e = 0;
                            (e =
                                (t.deltaY || -t.wheelDelta || t.detail) >> 10 ||
                                1),
                                (e *= 75);
                        ...
                        function (t) {
                            ...
                            "mouseover" === t.type
                                ? t.defaultPrevented ||
                                  (i.element.hover(!0),
                                  s &&
                                      (e.tooltip.text(i.tooltipText),
                                      e.tooltip.show(),
                                      e.emit(i.event, [e.tooltip, i.code])))
                                : (i.element.hover(!1), s && e.tooltip.hide());
                        }
                    ),
                    w.delegate(i, "mouseup", ".jvm-element", function (t) {
                        ...
                        if (
                            ...
                            (("region" === i.type &&
                                ...
                                ("marker" === i.type &&
                                    e.params.markersSelectable))
                        ) {
                            var s = i.element;
                            e.params[i.type + "sSelectableOne"] &&
                                e.clearSelected(i.type + "s"),
            ...
            coordsToPoint: function (t, e) {
                var i,
                    s,
                    a,
                    n = D.maps[this.params.map].projection,
                    r = n.centralMeridian;
                return (
                    (i = O[n.type](t, e, r)),
            ...
            getInsetForPoint: function (t, e) {
                var i,
                    s,
                    a = D.maps[this.params.map].insets;
            ...
            getMarkerPosition: function (t) {
                var e = t.coords;
                return D.maps[this.params.map].projection
            ...
            visualizeData: function (t) {
                "object" == typeof t &&
                    (this.dataVisualization = new L(t, this));
            },
        },
        T = {
        ...
        z = (function () {
            ...
            var e = t.prototype;
            return (
                (e._bindEventListeners = function () {
                    var t = this;
            ...
            return (
                ...
                (e.reset = function () {
                    ...
                    this.legendHorizontal &&
                        (c(this.legendHorizontal),
                        (this.legendHorizontal = null)),
                        this.legendVertical &&
                            (c(this.legendVertical),
