    ...
    (a.modules = {}),
        ...
        (a.alias = function (b, c) {
            if (!a.modules.hasOwnProperty(b))
                throw new Error(
                    'Failed to alias "' + b + '", it does not exist'
                );
            a.aliases[c] = b;
        }),
            ...
            (c.exports = function (a) {
                ...
                (d.prototype.add = function (a) {
                    ...
                    var b = this.array(),
                        c = e(b, a);
                    return (
                        ~c || b.push(a), (this.el.className = b.join(" ")), this
                    );
                }),
                    ...
                    init: function (d) {
                        (c = d),
                            (b = new List(c.listContainer.id, {
                                ...
                                searchClass:
                                    "pagination-search-route2-that-is-not-supposed-to-exist",
                                sortClass:
